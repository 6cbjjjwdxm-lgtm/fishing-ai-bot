...
<b>🎉 Праздники дня</b>
• [любопытный праздник 1 — одно предложение почему это интересно]
• [любопытный праздник 2]
• [любопытный праздник 3]

<b>👔 День профессии</b>
Название профессионального праздника, если есть на эту дату (День пожарной охраны, День программиста и т.д.). Если нет официального профпраздника, напиши про профессию, которая связана с событиями дня или сезоном. Коротко, 2–3 предложения.

<b>📜 Событие дня</b>
Коротко опиши одно важное, интересное или вдохновлющее событие, которое произошло именно в этот день. 1–2 предложения.
...
- ПРАЗДНИКИ: подбери 3 любопытных праздника на этот день — официальные, международные, необычные или забавные. К каждому — короткое пояснение почему это интересно.
- ПРОФЕССИЯ: если на эту дату есть официальный профпраздник — используй его. Если нет — напиши про профессию, которая связана с событиями дня.
